...
def _creator_context(bio: str, title_tag: str = "") -> str:
    ...
    if bio:
        ...
        parts.append(
            ...
            "loud, in plain words ('as a Senior Data Platform Engineer at Contoso', 'back when I was "
            "a Data Engineer at Northwind'). Vague gestures ('someone who has worked in big tech', "
        ...
        parts.append(
            ...
            "company's metric by a figure. From 'Data Platform Engineer at Northwind' you MAY say "
            "'when I was a Data Engineer at Northwind' — that is the credential itself — but NOT "
            "'when I rebuilt Northwind's recommendation pipeline' or 'I improved their fraud model "
            "by 20%'. "
        ...
        parts.append(
            ...
            "years as a Data Engineer at Northwind watching those dashboards during peak.' "
            "BAD (runway that kills the open): 'Hi, I am a Senior Data Platform Engineer at Contoso, "
    ...
    parts.append(
        ...
        "instead when it is both shorter and stronger there (e.g. 'from an ex-Northwind Data "
        "Engineer' on a Northwind video), as long as it stays truthful to the background above. Keep "
