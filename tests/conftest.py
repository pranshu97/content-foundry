...
_BASE_ENV = {
    ...
    # Off so the voiceover stage's pronunciation lookup doesn't add an LLM call to the fake sequence.
    "PRONUNCIATION_LLM_ENABLED": "false",
...
DEFAULT_SCRIPT_JSON = {
    ...
    "description": "Grounded in Adzuna data.",
